let api = 'http://localhost:3000/api/ingredients';
...
function initDataTable() {
    ...
    columns = [
        ...
        { "title": "unit_of_measurement", "data": "unit_of_measurement" },
        { "title": "amount_in_stock", "data": "amount_in_stock" }
...
function submitNew(api) {
    ...
    const formData = {
        ...
        amount_in_stock: $('#amount_in_stock').val(),
      }
...
function fillModal(record) {
    ...
    $("#amount_in_stock").val(record.amount_in_stock);
